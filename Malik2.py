#!/usr/bin/python
# coding=utf-8
# Originally Written By:Firdooslofar
# Source : Python2"
# Donot Recode It. 
...
➣ Github  : https://github.com/Nasir4567
➣ Facebook: MalikNasir
...
def menu_action():
    ...
    if act =="":
        ...
        os.system('clear')
        os.system('python2 MALIKNASIR2.py')
    elif act =="3":
        os.system('clear')
        print banner
        print
        ...
        os.system('xdg-open www.facebook.com/malik.Nasir.5214')
        menu()
def crack():
    os.system('clear')
    print banner
...
def crack_menu():
	...
	p.map(main, id)
	print "\033[1;97m----------------------------------------------"
	Malik('[✓] Process Has Been Completed.')
	Nasir('\033[1;97m[✓] Checkpoint IDS Has Been Saved.')
	xx = str(len(oks))
